...
public class DynamicTitleAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.czh_dynamic_title_item,parent,false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if(isClicks.get(position)){
            ((ViewHolder) holder).title.setBackground(context.getResources().getDrawable(R.drawable.czh_dynamic_title_bg));
        }else {
