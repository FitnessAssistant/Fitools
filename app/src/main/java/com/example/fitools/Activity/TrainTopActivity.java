...
import com.example.fitools.Fragment.TrainTopMonthsFragment;
import com.example.fitools.Fragment.TrainTopWeekendsFragment;
...
public class TrainTopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.time_top);
