...
public class DataItemAdapter extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_TYPE.ITEM_TYPE_One.ordinal()){
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.find_rv_item1,parent,false);

            return new ViewHolder1(view);

        }else if(viewType == ITEM_TYPE.ITEM_TYPE_Two.ordinal()){

            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.find_rv_item2,parent,false);
